...
namespace NewYearMovies.Core
{
    ...
    public static class MessageTexts
    {
        ...
        public const string NoTodayMovies = "На сьогодні фільмів немає :( Повний список фільмів - натисніть /movies";
        public const string LoadMore = "Завантажити більше";
        public const string SearchMovie = "дивитися онлайн на українській";

        public static Dictionary<int, string> DecDailyMessages { get; } = new () 
        { 
            { 4, StartText },
